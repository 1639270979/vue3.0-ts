  ...
  <div class="navbar-wrapper" :style="{ '--theme': theme }">
    ...
    <div class="right-menu">
      <template v-if="device !== 'mobile'">
        <i
          class="el-icon-refresh right-menu-item"
          :class="refreshing ? 'active' : ''"
          @click="refreshPage"
        ></i>
        ...
        >
          <el-badge
            :value="messageDataNum"
            :max="99"
            :hidden="messageDataNum > 0 ? false : true"
            class="item-icon"
          >
    ...
    <template v-dialogDrag:editPassword>
      ...
      >
        ...
        <template v-slot:footer>
          ...
          <el-button size="small" type="primary" @click="passwordChangeOk"
            >确 定</el-button
          >
        </template>
      </el-dialog>
